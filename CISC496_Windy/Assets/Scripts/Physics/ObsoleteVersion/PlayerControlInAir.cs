...
namespace Windy.Obsolete.Physics
{
    public class PlayerControlInAir : MonoBehaviour
    {
        ...
        {
            return !UnityEngine.Physics.Raycast(transform.position, Vector3.down, LowestFlyHeight, onGroundControl.GroundLayerMask);
        }
        public bool AboveMinimumFlightHeight(out RaycastHit hitInfo)
        {
            return !UnityEngine.Physics.Raycast(transform.position, Vector3.down, out hitInfo, LowestFlyHeight, onGroundControl.GroundLayerMask);
        }
