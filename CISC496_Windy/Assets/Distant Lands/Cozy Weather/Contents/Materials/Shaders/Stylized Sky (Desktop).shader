...
Shader "Distant Lands/Cozy/Stylized Sky Desktop"
{
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutput o )
		{
			...
			float temp_output_181_0 = min( tex2D( _StarTexture, (panner321*4.0 + mulTime175) ).r , tex2D( _SkyPatchwork, (rotator176*1.0 + 0.0) ).r );
...
Node;AmplifyShaderEditor.Vector3Node;64;-4331.223,404.3474;Inherit;False;Global;CZY_MoonDirection;CZY_MoonDirection;12;0;Create;True;0;0;0;False;0;False;0,0,0;0,0.8090171,-0.5877851;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
...
Node;AmplifyShaderEditor.Vector3Node;49;-4359.506,-458.4658;Inherit;False;Global;CZY_SunDirection;CZY_SunDirection;12;0;Create;True;0;0;0;False;0;False;0,0,0;0.7378387,-0.5573928,-0.3806671;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
...
Node;AmplifyShaderEditor.ScaleAndOffsetNode;178;240,-2688;Inherit;False;3;0;FLOAT2;0,0;False;1;FLOAT;1;False;2;FLOAT;0;False;1;FLOAT2;0
...
ASEEND*/
//CHKSM=98D676836D41C7D1220565A04BF921BB326DA5D6